...
import com.effigo.LearningPortal.service.FavoriteServiceImpl;
...
public class FavoriteController {
	private final FavoriteServiceImpl favService;

	public FavoriteController(FavoriteServiceImpl favService) {
