...
public interface UserEntityService {
	...
	UserEntityresponse saveUserEntity1(UserEntityrequest userentityrequest, UserType usertype, Long id, String username,
			String password);

	CourseEntityResponse saveCourseEntity1(CourseEntityrequest courseentityrequest, UserType usertype, Long id,
			String username, String password);

	CourseEntityResponse updateCourseEntity1(CourseEntityrequest courseentityrequest, UserType usertype, Long id,
			String username, String password, Long courseid);

	String saveFavoriteEntity(UserType usertype, Long id, String username, String password, Long courseid);

	String courseenrollment(UserType usertype, Long id, String username, String password, Long courseid);
